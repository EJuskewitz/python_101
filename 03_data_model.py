"""A Class in object orientated programming adhering to analyze molecular properties"""
...
class MolecularAnalyzer:
    ...
    def lipinskibarchart(self, summary_df):
        """Renders a barchart displaying adherence to 'other Lipinski rule' per rule"""
        # Clear previous plot
        self.ax2.cla()
